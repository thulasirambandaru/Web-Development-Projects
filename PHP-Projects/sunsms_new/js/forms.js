...
complaintSummary:"required",
	...
	/**** Staff Module Validations Code START ****/
    ...
    messages: {
        ...
        joining_date: {
            required: "Please Set Joining Date"
        },
        first_name: {
            required: "Please Enter First Name"
        },
		...
		teacher_department: {
			...
			notEqual: "Please Select Department"
        },
		teacher_type: {
            required: "Please Select Type",
			notEqual: "Please Select Type"
	...
	jQuery("#staff_type_form").validate({
        rules: {
            staff_type_name:{
                required: true
            }
	...
	jQuery("#class_teacher_form").validate({
        rules: {
            board_id:{
                required: true,
				notEqual: '0'
        ...
        messages: {
			...
			student_course_id:{
                ...
                notEqual: "Please Select Class"
            },
			teacher_id:{
                required: "Please Select Teacher",
                notEqual: "Please Select Teacher"
            }
        },
        /*submitHandler: function(form) {
         //billTemplateFormValidation();
	...
	/**** Staff Module Validations Code END ****/
	
	
    jQuery("#class_timeing_form").validate({
        rules: {            
            'name[]':{
                required:true
            },
    ...
    jQuery("#timetable_form").validate({
			//ignore: [],
            rules: {
				board_id:{
                    required: true,
            ...
            messages: {
				...
				course_section_id:{
                    ...
                    notEqual: "Please Select Section"
                }
            },
        /*submitHandler: function(form) {
         //billTemplateFormValidation();
	...
	jQuery("#assign_staff_subject").validate({
            rules: {
				staff:{
                    required: true,
                    notEqual: '0'
            ...
            messages: {
                staff:{
                    ...
                    notEqual: "Please Select Staff"
                },
				subject:{
                    required: "Please Select Subject",
                    notEqual: "Please Select Subject"
                }
            },
        /*submitHandler: function(form) {
         //billTemplateFormValidation();
    ...
    /**** Student Module Validations Code START ****/
    ...
    jQuery("#student_form").validate({
        ...
        messages: {
            ...
            nationality:{
                ...
                notEqual: "Please Select Nationality"
            },
            address_line_1:{
                required: "Please Enter Address"
            },
			...
			profile_photo:{
				...
				accept: 'File Must be .gif or .png or .jpg', 
				filesize: 'File Size Should be Less Than 1 MB'
			}
        },
        /*submitHandler: function(form) {
         //billTemplateFormValidation();
    ...
    jQuery("#student_parent_form").validate({
        rules: {
            parent_first_name:{
                required: true
            },
        ...
        messages: {
            ...
            relation_id:{
                ...
                notEqual: "Please Select Relation"
            },
            parent_dob:{
                required: 'Please Select Date of Birth',
                date: 'Please Enter Valid Date'
    ...
    jQuery("#student_prev_info").validate({
        rules: {
            student_prev_institute:{
                required: true
            },
            student_prev_year:{
                required: true
    ...
    /**** Student Module Validations Code END ****/

    jQuery("#admission_form").validate({
        rules: {
            admission_number: {
                required: true
            }
	...
	/**** Examination validations Start ****/
	
	jQuery("#exam_form").validate({
        rules: {
            name:{
                required: true
            }
	...
	jQuery("#exam_schedule_form").validate({
			//ignore: [],
            rules: {
				exam_id:{
                    required: true,
	...
	jQuery("#exam_grades").validate({
        ...
        messages: {
			...
			grade_value:{
                required: 'Please Enter Grade Value'
            },
			low_mark_range:{
                required: 'Please Enter Lower Mark Range'
            },
			upper_mark_range:{
                required: 'Please Enter Upper Mark Range'
            }
        },
        highlight: function(label) {
            jQuery(label).closest('.control-group').addClass('error');
	...
	jQuery("#exam_marks_form").validate({
			//ignore: [],
            rules: {
				exam_id:{
                    required: true,
	...
	/**** Examination validations END ****/
	
    /**** Add Section Start ****/
    jQuery("#section_form").validate({
        rules: {
            'board_id[]':{
                required: true,
                notEqual: '0'
	...
	/*function validateAddSection() {
		newAdded = $('#add_section_cnt').val();		
		for(i=1;i<=newAdded.length;i++) {
			if($('#section_name'+i).val() == '') {
				$('#section_name_err'+i).show();				
			}
		}
	}*/
