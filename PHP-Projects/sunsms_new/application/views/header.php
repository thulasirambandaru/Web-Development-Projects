...
if($this->session->userdata('user_id')){ //require_once('config/config.php');
	$school_image= commom_images();
	if($school_image['logo']!='')
		$logo="images/school/logo/".$school_image['logo'];
	else 
...
<html lang="en">
<head>
    <link rel=icon href="<?=BASE_URL?>images/school/favicon/Govt_PU.png"/>
	...
	<div class="top-container">
        ...
        <div class="navbar">
            <div class="navbar-inner">
                <a class="logo" href="#"><img src="<?=BASE_URL.$logo;?>"/> <span class="logo-txt">School Management System</span></a>
                <div class="top-container">
                    <button class="btn btn-navbar" data-toggle="collapse" data-target="#app-nav-top-bar">
                        <span class="icon-bar"></span>
                        <span class="icon-bar"></span>
                        ...
                        <div class="nav pull-right show-on-hover">
                            ...
                            <ul class="dropdown-menu" role="menu">
								...
								<?php if($this->session->userdata('user_id') && $this->session->userdata('user_type_id') > 0) { ?>
									<a href="<?=BASE_URL?>index.php/admin/changePassword">Change Password</a>
									<a href="<?=BASE_URL?>index.php/admin/logout">Logout</a>
        ...
        <div style="width:100%;margin-left:75%;color:black;"><?php echo $this->session->userdata('academic_year'); ?> | Welcome <?php echo $this->session->userdata('display_name');?></div>
        </div>
        <!-- END THEME CUSTOMIZER-->
	<?php $this->load->view('header_menu'); ?>
    <div id="body-content">
	<?php } else { ?>
<!DOCTYPE html><html><head>	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />	<meta name="viewport" content="width=1,initial-scale=1,user-scalable=1" />	<title>SUN SMS</title>	<link href="<?=BASE_URL?>css/font-google-apis.css" rel="stylesheet" type="text/css">    <link rel="stylesheet" href="http://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.6/css/bootstrap.min.css">	<link href="<?=BASE_URL?>css/customize-template.css" type="text/css" media="screen, projection" rel="stylesheet" />		<!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->    <!--[if lt IE 9]>      <script src="https://oss.maxcdn.com/html5shiv/3.7.2/html5shiv.min.js"></script>      <script src="https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>    <![endif]--></head>
<?php } ?>
