<?php if($this->session->userdata('user_id') && $this->session->userdata('user_type_id') > 0){ ?>
	...
	<div id="dialog-confirm" title="Confirm Delete" style='display:none;'>
		<p>
			...
			<span id='dialog-msg'>This item will be permanently deleted and cannot be recovered. Are you sure?</span>
		</p>
	</div>
	
    <footer class="application-footer">
        <div class="container">
            <div class="disclaimer">                				<p>Copyright © 2016. All rights reserved. SUN SMS</p>
            </div>
        </div>
    </footer>
    </div>
